...
if.then:                                          ; preds = %entry
  ...
  %.pre = mul nsw i32 %b, %a
  %.pre84 = mul nsw i32 %d, %c
  br label %if.end

if.else:                                          ; preds = %entry
  %mul30 = mul nsw i32 %b, %a
  %mul31 = mul nsw i32 %d, %c
  %add24 = add i32 %xor, %mul30
  %add22 = add i32 %add24, %mul31
...
if.end:                                           ; preds = %if.else, %if.then
  %mul35.pre-phi = phi i32 [ %mul31, %if.else ], [ %.pre84, %if.then ]
  %mul34.pre-phi = phi i32 [ %mul30, %if.else ], [ %.pre, %if.then ]
  %result.0 = phi i32 [ %add33, %if.else ], [ %add21, %if.then ]
  %add36 = add nsw i32 %mul35.pre-phi, %mul34.pre-phi
...
if.then20:                                        ; preds = %entry
  %mul25 = mul nsw i32 %d, %c
  %add21 = add i32 %add, %mul5
  %add22 = add i32 %add21, %add6
  %add23 = add i32 %add22, %mul25
...
if.end36:                                         ; preds = %if.then20, %if.else28, %if.then
  %mul38.pre-phi = phi i32 [ %mul25, %if.then20 ], [ %mul33, %if.else28 ], [ %.pre, %if.then ]
  %result.0 = phi i32 [ %add27, %if.then20 ], [ %add35, %if.else28 ], [ %add18, %if.then ]
  %add39 = add nsw i32 %mul38.pre-phi, %mul5
...
for.cond.cleanup:                                 ; preds = %for.body, %entry
  ...
  %add20 = add nsw i32 %result.0.lcssa, %add15
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %acc5.069 = phi i32 [ %xor12, %for.body ], [ %xor2, %entry ]
  %acc4.068 = phi i32 [ %xor10, %for.body ], [ %xor1, %entry ]
  %acc3.067 = phi i32 [ %xor8, %for.body ], [ %xor, %entry ]
  %acc2.066 = phi i32 [ %add6, %for.body ], [ %c, %entry ]
  %acc1.065 = phi i32 [ %add4, %for.body ], [ %b, %entry ]
  %acc0.064 = phi i32 [ %add, %for.body ], [ %a, %entry ]
  %result.063 = phi i32 [ %result.1, %for.body ], [ 0, %entry ]
...
if.else:                                          ; preds = %if.then
  %add6 = add nsw i32 %b, %a
  %mul7 = mul nsw i32 %add6, %c
  %add8 = add nsw i32 %mul7, %mul
  br label %if.end12
...
if.end12:                                         ; preds = %if.then3, %if.else, %if.else9
  ...
  %add13 = add nsw i32 %b, %a
  %mul17 = shl nsw i32 %add13, 1
  %mul20 = mul nsw i32 %add13, %c
  %mul17.pn = select i1 %cond1, i32 %mul17, i32 %mul20
  %add14 = add i32 %mul20, %add13

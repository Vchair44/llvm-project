...
if.end:                                           ; preds = %if.else, %if.then
  %lcm.phi360 = phi i32 [ %mul143, %if.else ], [ %lcm.tmp359, %if.then ]
  %lcm.phi = phi i32 [ %mul141, %if.else ], [ %lcm.tmp, %if.then ]
  %acc.0 = phi i64 [ %add146, %if.else ], [ %add76, %if.then ]
  %conv148 = sext i32 %lcm.phi to i64
  %conv150 = sext i32 %lcm.phi360 to i64
  %conv153 = sext i32 %xor to i64
  %conv154 = sext i32 %xor1 to i64
  %conv156 = sext i32 %xor2 to i64
  %conv158 = sext i32 %xor3 to i64
  %conv160 = sext i32 %xor4 to i64
  %conv162 = sext i32 %xor5 to i64
  %conv164 = sext i32 %xor6 to i64
  %conv166 = sext i32 %xor7 to i64
  %conv169 = sext i32 %xor8 to i64
  %conv170 = sext i32 %xor9 to i64
  %conv172 = sext i32 %xor10 to i64
  %conv174 = sext i32 %xor11 to i64
  %conv176 = sext i32 %xor12 to i64
  %conv178 = sext i32 %xor13 to i64
  %conv180 = sext i32 %xor14 to i64
  %conv182 = sext i32 %xor15 to i64
  %conv185 = sext i32 %a to i64
  %conv186 = sext i32 %b to i64
  %conv188 = sext i32 %c to i64
  %conv190 = sext i32 %d to i64
  %conv192 = sext i32 %e to i64
  %conv194 = sext i32 %f to i64
  %conv196 = sext i32 %g to i64
  %conv198 = sext i32 %h to i64
  %conv201 = sext i32 %i to i64
  %conv202 = sext i32 %j to i64
  %conv204 = sext i32 %k to i64
  %conv206 = sext i32 %l to i64
  %conv208 = sext i32 %m to i64
  %conv210 = sext i32 %n to i64
  %conv212 = sext i32 %o to i64
  %conv214 = sext i32 %p to i64
  %add151 = add nsw i64 %conv186, %conv185
  %add152 = add nsw i64 %add151, %conv188
  %add155 = add nsw i64 %add152, %conv153
  %add157 = add nsw i64 %add155, %conv148
  %add159 = add nsw i64 %add157, %conv190
  %add161 = add nsw i64 %add159, %conv154
  %add163 = add nsw i64 %add161, %conv192
  %add165 = add nsw i64 %add163, %conv156
  %add167 = add nsw i64 %add165, %conv150
  %add168 = add nsw i64 %add167, %conv194
  %add171 = add nsw i64 %add168, %conv158
  %add173 = add nsw i64 %add171, %conv196
  %add175 = add nsw i64 %add173, %conv160
  %add177 = add nsw i64 %add175, %conv198
  %add179 = add nsw i64 %add177, %conv162
  %add181 = add nsw i64 %add179, %conv201
  %add183 = add nsw i64 %add181, %conv164
  %add184 = add nsw i64 %add183, %conv202
  %add187 = add nsw i64 %add184, %conv166
  %add189 = add nsw i64 %add187, %conv204
  %add191 = add nsw i64 %add189, %conv169
  %add193 = add nsw i64 %add191, %conv206
  %add195 = add nsw i64 %add193, %conv170
  %add197 = add nsw i64 %add195, %conv208
  %add199 = add nsw i64 %add197, %conv172
  %add200 = add nsw i64 %add199, %conv210
  %add203 = add nsw i64 %add200, %conv174
  %add205 = add nsw i64 %add203, %conv212
  %add207 = add nsw i64 %add205, %conv176
  %add209 = add nsw i64 %add207, %conv214
  %add211 = add nsw i64 %add209, %conv178
  %add213 = add nsw i64 %add211, %conv180
  %add215 = add nsw i64 %add213, %conv182
...
if.end108:                                        ; preds = %if.then62, %if.else85, %if.then
  %lcm.phi286 = phi i32 [ %mul81, %if.then62 ], [ %mul104, %if.else85 ], [ %lcm.tmp285, %if.then ]
  %lcm.phi = phi i32 [ %mul79, %if.then62 ], [ %mul102, %if.else85 ], [ %lcm.tmp, %if.then ]
  %acc.0 = phi i64 [ %add84, %if.then62 ], [ %add107, %if.else85 ], [ %add60, %if.then ]
  %conv110 = sext i32 %lcm.phi to i64
  %conv112 = sext i32 %lcm.phi286 to i64
  %conv115 = sext i32 %xor1 to i64
  %conv116 = sext i32 %xor3 to i64
  %conv118 = sext i32 %xor5 to i64
  %conv120 = sext i32 %xor7 to i64
  %conv122 = sext i32 %xor9 to i64
  %conv124 = sext i32 %xor11 to i64
  %conv126 = sext i32 %xor13 to i64
  %conv128 = sext i32 %xor15 to i64
  %conv131 = sext i32 %xor17 to i64
  %conv132 = sext i32 %xor19 to i64
  %conv134 = sext i32 %xor21 to i64
  %conv136 = sext i32 %xor23 to i64
  %conv138 = sext i32 %xor25 to i64
  %conv140 = sext i32 %xor27 to i64
  %conv142 = sext i32 %xor29 to i64
  %conv144 = sext i32 %xor31 to i64
  ...
  %add117 = add nsw i64 %add114, %conv110
  %add119 = add nsw i64 %add117, %conv152
  %add121 = add nsw i64 %add119, %conv115
  %add123 = add nsw i64 %add121, %conv154
  %add125 = add nsw i64 %add123, %conv116
  %add127 = add nsw i64 %add125, %conv112
  %add129 = add nsw i64 %add127, %conv156
  %add130 = add nsw i64 %add129, %conv118
  %add133 = add nsw i64 %add130, %conv158
  %add135 = add nsw i64 %add133, %conv120
  %add137 = add nsw i64 %add135, %conv160
  %add139 = add nsw i64 %add137, %conv122
  %add141 = add nsw i64 %add139, %conv163
  %add143 = add nsw i64 %add141, %conv124
  %add145 = add nsw i64 %add143, %conv164
  %add146 = add nsw i64 %add145, %conv126
  %add149 = add nsw i64 %add146, %conv166
  %add151 = add nsw i64 %add149, %conv128
  %add153 = add nsw i64 %add151, %conv168
  %add155 = add nsw i64 %add153, %conv131
  %add157 = add nsw i64 %add155, %conv170
  %add159 = add nsw i64 %add157, %conv132
  %add161 = add nsw i64 %add159, %conv172
  %add162 = add nsw i64 %add161, %conv134
  %add165 = add nsw i64 %add162, %conv174
  %add167 = add nsw i64 %add165, %conv136
  %add169 = add nsw i64 %add167, %conv176
  %add171 = add nsw i64 %add169, %conv138
  %add173 = add nsw i64 %add171, %conv140
  %add175 = add nsw i64 %add173, %conv142
  %add177 = add nsw i64 %add175, %conv144

...
if.end:                                           ; preds = %if.else, %if.then
  %xor28.pre-phi = phi i32 [ %xor23, %if.else ], [ %.pre, %if.then ]
  ...
  %conv29 = sext i32 %xor28.pre-phi to i64
...
if.else59:                                        ; preds = %if.end
  ...
  %.pre3 = sext i32 %a to i64
  %.pre4 = mul nsw i64 %.pre2, %.pre3
  br label %if.end71

if.end71:                                         ; preds = %if.else59, %if.then45
  %mul75.pre-phi = phi i64 [ %.pre4, %if.else59 ], [ %mul57, %if.then45 ]
  %conv74.pre-phi = phi i64 [ %.pre3, %if.else59 ], [ %conv56, %if.then45 ]
  %conv73.pre-phi = phi i64 [ %.pre2, %if.else59 ], [ %conv55, %if.then45 ]
  %xor72.pre-phi = phi i32 [ %.pre1, %if.else59 ], [ %xor54, %if.then45 ]
  %acc.1 = phi i64 [ %add58, %if.then45 ], [ %add70, %if.else59 ]
  %add76 = add i64 %mul75.pre-phi, %mul31
...
if.then93:                                        ; preds = %if.then91
  ...
  %add97 = add i64 %mul101, %mul75.pre-phi
...
if.then123:                                       ; preds = %if.else121
  ...
  %add126 = add i64 %mul131, %mul75.pre-phi
...
if.end146:                                        ; preds = %if.else138, %if.then123, %if.else108, %if.then93
  ...
  %add156 = add i64 %add151, %mul75.pre-phi
...
for.body:                                         ; preds = %for.body, %sw.bb69
  %result.0276 = phi i64 [ %mul72, %sw.bb69 ], [ %add80, %for.body ]
  %i.0275 = phi i32 [ 0, %sw.bb69 ], [ %inc, %for.body ]
  ...
  br i1 %exitcond.not, label %sw.epilog, label %for.body, !llvm.loop !9
...
sw.epilog:                                        ; preds = %sw.default, %sw.bb94, %sw.bb81, %for.body, %sw.bb48, %sw.bb37, %sw.bb20, %sw.bb
  %result.1 = phi i64 [ %add124, %sw.default ], [ %add19, %sw.bb ], [ %add36, %sw.bb20 ], [ %add47, %sw.bb37 ], [ %add68, %sw.bb48 ], [ %add106, %sw.bb94 ], [ %add93, %sw.bb81 ], [ %add80, %for.body ]
  %mul125 = mul nsw i32 %b, %a
  %conv126 = sext i32 %mul125 to i64
  %mul127 = mul nsw i32 %d, %c
  %conv128 = sext i32 %mul127 to i64
  %add129 = add nsw i64 %conv128, %conv126
  %add131 = add nsw i32 %b, %a
  %conv132 = sext i32 %add131 to i64
  %add133 = add nsw i32 %d, %c
  %conv134 = sext i32 %add133 to i64
  %mul135 = mul nsw i64 %conv134, %conv132
  %add139 = add nsw i32 %mul127, %mul125
  %mul142 = mul nsw i32 %add133, %add131
  ...
  %xor152277 = xor i32 %add4, %add
  %xor154278 = xor i32 %xor152277, %add7
...
for.cond.cleanup:                                 ; preds = %entry.for.cond.cleanup_crit_edge, %if.end
  %conv45.pre-phi = phi i64 [ %.pre6, %entry.for.cond.cleanup_crit_edge ], [ %conv23, %if.end ]
  %mul44.pre-phi = phi i32 [ %.pre5, %entry.for.cond.cleanup_crit_edge ], [ %mul22, %if.end ]
  %carry1.0.lcssa = phi i32 [ %b, %entry.for.cond.cleanup_crit_edge ], [ %xor5, %if.end ]
  %carry2.0.lcssa = phi i32 [ %c, %entry.for.cond.cleanup_crit_edge ], [ %mul7, %if.end ]
  %carry0.0.lcssa = phi i32 [ %a, %entry.for.cond.cleanup_crit_edge ], [ %xor, %if.end ]
  %result.0.lcssa = phi i64 [ 0, %entry.for.cond.cleanup_crit_edge ], [ %result.1, %if.end ]
  %add46 = add nsw i64 %result.0.lcssa, %conv45.pre-phi
  br i1 %cmp218, label %for.body54.lr.ph, label %for.cond.cleanup.for.cond.cleanup53_crit_edge

for.cond.cleanup.for.cond.cleanup53_crit_edge:    ; preds = %for.cond.cleanup
  %.pre7 = add nsw i32 %b, %a
  %.pre8 = add nsw i32 %.pre7, %c
...
for.body:                                         ; preds = %if.end, %for.body.lr.ph
  ...
  %result.0223 = phi i64 [ 0, %for.body.lr.ph ], [ %result.1, %if.end ]
  %carry0.0222 = phi i32 [ %a, %for.body.lr.ph ], [ %xor, %if.end ]
  %carry2.0220 = phi i32 [ %c, %for.body.lr.ph ], [ %mul7, %if.end ]
  %carry1.0219 = phi i32 [ %b, %for.body.lr.ph ], [ %xor5, %if.end ]
  %2 = trunc i64 %indvars.iv to i32
  %3 = mul i32 %2, 1000003
  %add = add nsw i32 %3, %carry0.0222
...
for.cond.cleanup53.loopexit:                      ; preds = %if.end90
  %6 = xor i32 %xor58, %carry0.0.lcssa
  br label %for.cond.cleanup53

for.cond.cleanup53:                               ; preds = %for.cond.cleanup.for.cond.cleanup53_crit_edge, %for.cond.cleanup53.loopexit
  %conv115.pre-phi = phi i64 [ %.pre9, %for.cond.cleanup.for.cond.cleanup53_crit_edge ], [ %conv79, %for.cond.cleanup53.loopexit ]
  %add114.pre-phi = phi i32 [ %.pre8, %for.cond.cleanup.for.cond.cleanup53_crit_edge ], [ %add78, %for.cond.cleanup53.loopexit ]
  %add113.pre-phi = phi i32 [ %.pre7, %for.cond.cleanup.for.cond.cleanup53_crit_edge ], [ %add77, %for.cond.cleanup53.loopexit ]
  %carry3.0.lcssa = phi i32 [ %carry1.0.lcssa, %for.cond.cleanup.for.cond.cleanup53_crit_edge ], [ %6, %for.cond.cleanup53.loopexit ]
  ...
  %mul116 = mul nsw i64 %conv112, %conv115.pre-phi
  %add117 = add nsw i64 %mul116, %conv45.pre-phi
  %add118 = add nsw i64 %add117, %result.2.lcssa
  %xor120 = sext i32 %carry3.0.lcssa to i64
  %xor122 = xor i64 %add118, %xor120
  ret i64 %xor122

for.body54:                                       ; preds = %if.end90, %for.body54.lr.ph
  %indvars.iv240 = phi i64 [ 0, %for.body54.lr.ph ], [ %indvars.iv.next241, %if.end90 ]
  %result.2232 = phi i64 [ %add46, %for.body54.lr.ph ], [ %add105, %if.end90 ]
  %carry5.0230 = phi i32 [ %xor49, %for.body54.lr.ph ], [ %mul62, %if.end90 ]
  %carry4.0229 = phi i32 [ %xor48, %for.body54.lr.ph ], [ %xor60, %if.end90 ]
  %carry3.0228 = phi i32 [ %xor47, %for.body54.lr.ph ], [ %xor58, %if.end90 ]
  %7 = trunc i64 %indvars.iv240 to i32
  %8 = mul i32 %7, 1664525
  %add57 = add nsw i32 %8, %carry3.0228
...
if.then65:                                        ; preds = %for.body54
  %9 = add nsw i64 %indvars.iv240, %conv91
  %add69 = add nsw i32 %xor58, %c
  %conv70 = sext i32 %add69 to i64
  %mul71 = mul nsw i64 %9, %conv70
  %mul80 = mul nsw i64 %indvars.iv240, %conv79
  %add72 = add i64 %result.2232, %conv45.pre-phi
  %add81 = add i64 %add72, %mul80
  %add82 = add i64 %add81, %mul71
  %.pre = sext i32 %xor58 to i64
  %.pre1 = sext i32 %xor60 to i64
  %.pre3 = sext i32 %mul62 to i64
  br label %if.end90
...
if.end90:                                         ; preds = %if.else83, %if.then65
  %.pre-phi4 = phi i64 [ %conv87, %if.else83 ], [ %.pre3, %if.then65 ]
  %.pre-phi2 = phi i64 [ %conv85, %if.else83 ], [ %.pre1, %if.then65 ]
  %.pre-phi = phi i64 [ %conv84, %if.else83 ], [ %.pre, %if.then65 ]
  %result.3 = phi i64 [ %add82, %if.then65 ], [ %add89, %if.else83 ]
  %10 = add nsw i64 %indvars.iv240, %.pre-phi
  %mul94 = mul nsw i64 %10, %conv91
  %11 = add nsw i64 %indvars.iv240, %.pre-phi2
  %mul99 = mul nsw i64 %11, %conv96
  %12 = add nsw i64 %indvars.iv240, %.pre-phi4
  %mul104 = mul nsw i64 %12, %conv101
  ...
  br i1 %exitcond249.not, label %for.cond.cleanup53.loopexit, label %for.body54, !llvm.loop !13
}
...
if.then47:                                        ; preds = %if.end36
  ...
  %.pre = sext i32 %xor to i64
  %.pre1 = sext i32 %add16 to i64
  %.pre2 = sext i32 %add17 to i64
  %.pre3 = mul nsw i64 %.pre2, %.pre1
  %.pre5 = add nsw i64 %.pre3, %.pre
  br label %if.end74
...
if.else:                                          ; preds = %if.end36
  ...
  %.pre4 = sext i32 %mul37 to i64
  br label %if.end74

if.end74:                                         ; preds = %if.else, %if.then47
  %add79.pre-phi = phi i64 [ %add67, %if.else ], [ %.pre5, %if.then47 ]
  %conv98.pre-phi = phi i64 [ %.pre4, %if.else ], [ %conv48, %if.then47 ]
  %mul84.pre-phi = phi i64 [ %mul72, %if.else ], [ %.pre3, %if.then47 ]
  %conv83.pre-phi = phi i64 [ %conv71, %if.else ], [ %.pre2, %if.then47 ]
  %conv81.pre-phi = phi i64 [ %conv69, %if.else ], [ %.pre1, %if.then47 ]
  %conv78.pre-phi = phi i64 [ %xor66, %if.else ], [ %.pre, %if.then47 ]
  ...
  %mul101 = mul nsw i64 %conv98.pre-phi, %conv93
  %add85 = add nsw i64 %add79.pre-phi, %conv95
...
entry:
  ...
  br i1 %process_row1, label %if.then, label %if.end
...
if.end:                                           ; preds = %if.then, %entry
  %result.0 = phi i64 [ %add92, %if.then ], [ %add, %entry ]
  br i1 %process_row2, label %if.then94, label %if.end.if.end145_crit_edge

if.end.if.end145_crit_edge:                       ; preds = %if.end
  %.pre = sext i32 %mul to i64
  %.pre1 = mul nsw i32 %m23, %m12
  %.pre2 = sext i32 %.pre1 to i64
  %.pre3 = sext i32 %mul3 to i64
  %.pre4 = mul nsw i32 %m22, %m11
  %.pre5 = sext i32 %.pre4 to i64
  %.pre6 = mul nsw i32 %m23, %m11
  br label %if.end145
...
if.end145:                                        ; preds = %if.end.if.end145_crit_edge, %if.then94
  %mul160.pre-phi = phi i32 [ %.pre6, %if.end.if.end145_crit_edge ], [ %mul107, %if.then94 ]
  %conv155.pre-phi = phi i64 [ %.pre5, %if.end.if.end145_crit_edge ], [ %conv136, %if.then94 ]
  %mul154.pre-phi = phi i32 [ %.pre4, %if.end.if.end145_crit_edge ], [ %mul104, %if.then94 ]
  %conv153.pre-phi = phi i64 [ %.pre3, %if.end.if.end145_crit_edge ], [ %conv131, %if.then94 ]
  %conv149.pre-phi = phi i64 [ %.pre2, %if.end.if.end145_crit_edge ], [ %conv141, %if.then94 ]
  %mul148.pre-phi = phi i32 [ %.pre1, %if.end.if.end145_crit_edge ], [ %mul110, %if.then94 ]
  %conv147.pre-phi = phi i64 [ %.pre, %if.end.if.end145_crit_edge ], [ %conv126, %if.then94 ]
  %result.1 = phi i64 [ %add144, %if.then94 ], [ %result.0, %if.end.if.end145_crit_edge ]
  %mul156 = mul nsw i64 %conv155.pre-phi, %conv153.pre-phi
  %conv159 = sext i32 %mul6 to i64
  %conv161 = sext i32 %mul160.pre-phi to i64
  ...
  %reass.add336 = add nsw i64 %conv155.pre-phi, %conv147.pre-phi
  %reass.mul337 = mul i64 %reass.add336, %conv149.pre-phi
...
cond.end:                                         ; preds = %cond.true, %entry
  %cond = phi i32 [ %conv.i, %cond.true ], [ 12345, %entry ]
  br label %for.body
...
for.body:                                         ; preds = %for.body, %cond.end
  %sink.0131 = phi i64 [ 0, %cond.end ], [ %add69, %for.body ]
  %i.0130 = phi i32 [ 0, %cond.end ], [ %inc, %for.body ]
